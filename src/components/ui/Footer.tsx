...
const Icons = {
    gitHub: (props: IconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="30px" height="30px" viewBox="0 0 1024 1024" className="icon" fill="#fff" {...props}>
    ...
    instagram: (props: IconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48" {...props}>
