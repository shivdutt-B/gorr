...
export function Join() {
  ...
  return (
    <div className="flex justify-center items-center h-screen relative">
      <Link
        to="/"
        className="absolute top-5 left-5 cursor-pointer transition-colors duration-300 ease-in-out"
      >
        <div className="flex items-center bg-white hover:bg-gray-100 rounded-full p-2 shadow-md transition-all duration-300 ease-in-out overflow-hidden relative w-10 h-10 hover:scale-110">
          <svg
            ...
            className="transform transition-transform duration-300 animate-pulse hover:animate-none"
          >
      ...
      <div className="flex flex-col justify-between items-center">
        <div className="p-[10px] rounded-full bg-white">
          ...
          >
            ...
            >
              <path
                d="M440 2592 l-154 -27 -28 -115 c-16 -63 -40 -165 -54 -226 l-25 -111
...
58 0 c52 0 62 3 87 30 35 37 44 37 97 4z"
        ...
        <div className="text-center mt-36">
          ...
          >
            <RainbowButton className="text-black mt-10">
              <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 1024 1024" className="icon" fill="black">
              ...
              <span className="px-2">Authorize</span>
            </RainbowButton>
          </div>
        </div>
      </div>
