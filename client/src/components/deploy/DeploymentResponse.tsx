    ...
    <AnimatePresence>
      {showResponse && (isDeploying || error || deploymentData) && (
        <motion.div
          ...
          className="mt-6 overflow-hidden rounded-[4px]"
        >
          {error && (
            <div className="bg-red-900/20 border border-red-900/50 text-red-500 p-4 rounded-[4px]">
          ...
          {isQueued && !error && (
            <div className="bg-blue-900/20 border border-blue-900/50 text-blue-500 p-4 rounded-[4px]">
          ...
          {isDeploying && !isQueued && (
            <div className="bg-[#1A1A1A] p-4 rounded-[4px]">
          ...
          {deploymentUrl && !isDeploying && !error && !isQueued && (
            <div className="bg-green-900/20 border border-green-900/50 text-green-500 p-4 rounded-[4px]">
              ...
              <div className="text-sm space-y-2">
                <p className=" rounded-[4px]">
                  ...
                  <a
                    ...
                    className="font-mono bg-green-900/30 px-2 py-1 rounded text-green-400 hover:text-green-300 transition-colors border border-green-800"
                  >
                    {deploymentUrl}
                  </a>
                </p>
