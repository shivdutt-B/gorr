...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="group block relative">
      ...
      >
        {/* Website Preview */}
        <div className="relative w-full aspect-video mb-[20px] rounded-[4px] overflow-hidden border border-gray-800 bg-white">
          <iframe
        ...
        <div className="flex flex-col gap-3 relative z-[2]">
          ...
          <div className="truncate text-gray-500">
            <a
              href={project.projectUrl}
              className="flex-inline text-[15px] text-gray-500 hover:text-[hsl(var(--accent))] group font-[450]"
              target="_blank"
              rel="noopener noreferrer"
            >
              {project.projectUrl}
          ...
          <div>
            ...
            >
              ...
              <span className="text-[13px] text-black font-[550]">
