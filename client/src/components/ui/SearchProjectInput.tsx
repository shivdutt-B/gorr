...
function SearchProjectInput() {
    return (
        <div className="flex items-center p-2 rounded-lg space-x-2 max-w-[1300px] mx-auto mt-5">
            {/* Search Input */}
            ...
            <Link to="/import" className="px-3 py-[8px] flex items-center space-x-1 bg-white text-black border border-gray-300 rounded-[3px] hover:bg-gray-200">
                <span className="text-[14px] font-[600] hidden sm:block">Add New...</span>
