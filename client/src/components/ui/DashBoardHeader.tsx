    ...
    return (
        <div className="relative flex items-center justify-between p-3 rounded-lg text-white">
            ...
            <div className="flex items-center space-x-2">
                <Link to="/" className="w-[45px] h-[45px] bg-white rounded-full flex items-center justify-center">
                ...
                <div className="flex items-center space-x-1">
                    ...
                    <span className="font-medium">Shivdutt's projects</span>
                </div>
            </div>
            ...
            <div className="flex items-center space-x-4 text-gray-300 relative">
                ...
                <div className="relative">
                    ...
                    >
                        <img src={user?.avatar_url} className="w-full h-full rounded-full" alt="User Avatar" />
                    </div>
