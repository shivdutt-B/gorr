        ...
        <div className="bg-[#0a0a0a] text-white p-6 rounded-xl border border-gray-800 max-w-[800px] w-full m-4 mx-auto shadow-lg">
            ...
            <div className="flex items-center space-x-2 mb-4">
                <div className="bg-[#0a0a0a] p-2 px-4 rounded-lg flex items-center justify-between w-1/2 cursor-pointer border border-gray-700">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="20px" height="20px" viewBox="0 0 1024 1024">
            ...
            <div className="flex flex-col items-center">
                ...
                {visibleCount < filteredRepos.length && (
                    <div onClick={loadMore} className="flex mt-3 text-gray-400 text-sm cursor-pointer hover:text-white transition group">
                        <p className="transition-transform group-hover:translate-x-1">Load More</p>
                    </div>
                )}

                {/* Import Third-Party Repository Link */}
                <Link to="/" className="mt-3 text-gray-400 text-sm cursor-pointer hover:text-white transition group">
                    <span className="transition-transform group-hover:translate-x-1">Import Third-Party Git Repository →</span>
                </Link>
            </div>
        </div>
    );
