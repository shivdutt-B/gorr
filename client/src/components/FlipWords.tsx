    ...
    <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden px-4 py-8 sm:px-6">
      ...
      <div className="relative z-10 w-full max-w-7xl">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <a
            href="#"
            className="mt-8 inline-flex items-center justify-center rounded-full bg-[var(--accent)] px-5 py-2.5 text-sm font-medium text-black transition-transform hover:-translate-y-0.5"
          >
            Build Your Own <span className="ml-2">→</span>
          </a>
        </div>
