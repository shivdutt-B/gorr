	...
	return (
		...
		>
			...
			<div className="flex items-center gap-3 sm:gap-4">
				<Link
					to="/"
					className="inline-flex items-center gap-2 border border-white/20 bg-white/0 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-white/5 rounded-[2px]"
				>
					<span>Dashboard</span>
				</Link>
				...
				{user ? (
							...
							<div className="absolute right-0 top-[calc(100%+0.75rem)] w-72 overflow-hidden border border-white/10 bg-[#0b0c11]/95 p-3 text-left shadow-panel backdrop-blur-[10px]">
								...
								<div className="flex flex-col gap-2 pt-3">
									<Link
										...
										className="inline-flex items-center justify-between px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-white/10"
									>
										<span>Dashboard</span>
										<span>↗</span>
									</Link>
					...
					<Link
						to="/join"
						className="inline-flex items-center gap-2 bg-[hsl(var(--accent))] px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-[hsl(var(--accent-strong))] rounded-[2px]"
					>
						<span>Auth</span>
